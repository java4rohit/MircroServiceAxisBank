...
import com.java4rohit.accounts.dto.ResponseDto;
...
@Tag(name = "CRUD REST API for Accounts for AxisBank")
@RestController
...
public class AccountsController {
    ...
    @Operation(
            summary = "Fetch Account Details REST API", description = "REST API to fetch Customer &  Account details based on a mobile number"
    )
    @ApiResponses({
